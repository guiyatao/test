...
//SCM 终端店 交易详情
$lang['client_order_manage']         = '批发订货';
$lang['client_order_manage_subhead'] = '终端店向供应商批发订购的交易订单查询及管理';
$lang['client_order_help1']			 = '终端店向供应商批发订购的所有订单列表，点击可查看订单详情';
$lang['stockout_index_brand']        = '缺货订单';
$lang['stockout_subhead']            = '终端店缺货商品列表，选中商品可以直接向供应商下订单。';
$lang['cancel_order_index_brand']    = '取消订单';
$lang['cancel_order_subhead']        = '已下单，还未发货的订单，可以直接取消。';
$lang['order_storage_index_brand']   = '订单入库';
$lang['order_storage_subhead']       = '已下单，已经发货的订单，在收到商品之后可以进行入库操作。';
$lang['client_cart']                 = '购物车';
$lang['hot_goods']                   = '热销商品';
$lang['favorite_goods']              = '收藏商品';
