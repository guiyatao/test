...
class adminControl extends SCMControl{
    private $links = array(
        ...
        if (!empty($list) && is_array($list)){
            ...
            foreach ($list as $k => $v){
                ...
                if ($v['admin_is_super'] != 1) {
                    ...
                    $operation .= '<a class="btn blue" href="index.php?act=admin&op=admin_edit&admin_id='.$v['admin_id'].'"><i class="fa fa-pencil-square-o"></i>'.L('nc_edit').'</a>';
                }else {
                    $operation = '--';
                }
