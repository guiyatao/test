...
<div class="page">
    ...
    <form id="add_form" method="post">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label for="admin_name"><em>*</em>供应商名称</label>
                </dt>
                <dd class="opt">
                    <input type="text" id="admin_name" name="supp_ch_name" class="input-txt">
                    <span class="err"></span>
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="admin_password"><em>*</em>详细地址</label>
                </dt>
                <dd class="opt">
                    <input type="text" id="admin_password" name="supp_address" class="input-txt">
                    <span class="err"></span>
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="admin_password"><em>*</em>手机号</label>
                </dt>
                <dd class="opt">
                    <input type="text" id="admin_rpassword" name="supp_mobile" class="input-txt">
                    <span class="err"></span>
