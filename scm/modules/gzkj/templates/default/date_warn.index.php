...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=date_warn&op=get_xml',
        colModel : [
            ...
            {display: '商品生产日期', name : 'production_date', width : 120,  align: 'center'},
            {display: '商品有效期', name : 'shelf_life', width : 90,  align : 'center'},
			{display: '商品有效期预警天数', name : 'valid_remind', width : 120,  align: 'center'},
...
function fg_csv(ids) {
    id = ids.join(',');
    window.location.href = 'index.php?act=date_warn&op=export_date_warn&id=' + id;
}
</script> 
