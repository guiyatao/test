...
<div class="page">
    ...
    <form id="admin_form" method="post" action='index.php?act=kucun_setting&op=index'>
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" class="input-txt" name="goods_high_stock" value=""  />
                    <span class="err"></span>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" class="input-txt" name="goods_low_stock" value=""  />
                    <span class="err"></span>
                </dd>
            </dl>
