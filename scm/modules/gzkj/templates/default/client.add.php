...
<div class="page">
    ...
    <form id="add_form" method="post">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label for="admin_name"><em>*</em>终端店名称</label>
                </dt>
                <dd class="opt">
                    <input type="text" id="admin_name" name="clie_ch_name" class="input-txt">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" id="admin_password" name="clie_address" class="input-txt">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" id="admin_rpassword" name="clie_mobile" class="input-txt">
                    <span class="err"></span>
