...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=stock_warn&op=get_xml',
        colModel : [
            ...
            {display: '库存下限', name : 'goods_low_stock', width : 90,  align : 'center'},
            ...
            {display: '预警', name : 'operation', width : 80,  align: 'center'},
            ],
        buttons : [
...
function fg_csv(ids) {
    id = ids.join(',');
    window.location.href = 'index.php?act=stock_warn&op=export_stock_warn&id=' + id;
}
</script> 
