...
<div class="page">
    <div class="tabmenu">
        <?php include template('submenu');?>
    </div>
    <div class="alert mt10" style="clear:both;">
        <ul class="mt5">

            <li>1、以下列表为从昨天开始最近30天有效订单中的所有商品数据</li>
            <li>2、近30天下单商品数：从昨天开始最近30天有效订单的某商品总销量</li>
            <li>3、近30天下单金额：从昨天开始最近30天有效订单的某商品总销售额</li>
            <li>4、点击每列旁边的箭头对列表进行排序，默认按照“近30天成交件数”降序排列</li>
            <li>5、点击每条记录后的“走势图”，查看最近30天下单金额、下单商品数、下单量走势</li>
        </ul>
    </div>
...
<!--                    <td><div class="pic-thumb"><a href="--><?php //echo urlShop('goods', 'index', array('goods_id' => $v['goods_id']));?><!--" target="_blank"><img src="--><?php //echo thumb($v, 60);?><!--"/></a></div></td>-->
                    ...
                    <td><a href="javascript:void(0);" nc_type='showdata' data-param='{"gid":"<?php echo $v['goods_barcode'];?>"}'>走势图</a></td>
                </tr>
            <?php }?>
        <?php } else { ?>
            <tr>
