...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title"><a class="back" href="index.php?act=capital&op=index" title="返回资金列表"><i class="fa fa-arrow-circle-o-left"></i></a>
            <div class="subject">
                <h3><?php echo "资金表管理"?> - <?php echo "修改"?></h3>
    ...
    <form id="capital_form" method="post">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="<?=$output["capital"]["supp_bank"]?>" name="supp_bank" id="supp_bank" class="input-txt">
                    <span class="err"></span>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="<?=$output["capital"]["supp_cardno"]?>" name="supp_cardno" id="supp_cardno" class="input-txt">
                    <span class="err"></span>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="<?=$output["capital"]["supp_capital"]?>" name="supp_capital" id="supp_capital" class="input-txt">
                    <span class="err"></span>
                </dd>
            </dl>
            <input type="hidden" name="capital_id" id="capital_id" value="<?=$output['capital']['capital_id']?>" />
