...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title"><a class="back" href="index.php?act=category&op=index" title="返回分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
            <div class="subject">
                <h3><?php echo "商品分类管理"?> - <?php echo "新增"?></h3>
    ...
    <form id="category_form" enctype="multipart/form-data" method="post">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="" name="category_name" id="category_name" class="input-txt">
                    <span class="err"></span>
                </dd>
            </dl>
            <dl class="row">
                    ...
                    <select name="pid" class="valid">
                        ...
                        <?php if(!empty($output['parent_list']) && is_array($output['parent_list'])){ ?>
                            <?php foreach($output['parent_list'] as $k => $v){ ?>
                                <option <?php if($output['pid'] == $v['cate_id']){ ?>selected='selected'<?php } ?> value="<?php echo $v['cate_id'];?>"><?php echo $v['category_name'];?></option>
                            <?php } ?>
                        <?php } ?>
                    </select>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="radio" name="is_open" value="1" checked /> 开启
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="0" name="sort" id="sort" class="input-txt">
                    <span class="err"></span>
