...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title"><a class="back" href="index.php?act=clerk&op=clerk" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
            <div class="subject">
                <h3><?php echo "业务员管理"?> - <?php echo "新增业务员"?></h3>
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            <li>可从管理平台手动添加一名新业务员，并填写相关信息。</li>
            <li>标识“*”的选项为必填项，其余为选填项。</li>
            <li>新增业务员后可从业务员列表中找到该条数据，并再次进行编辑操作，但该业务员名称不可变。</li>
        </ul>
    </div>
    <form id="clerk_form" enctype="multipart/form-data" method="post">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label for="clerk_en_name"><em>*</em>业务员登录名</label>
                </dt>
                <dd class="opt">
                    <input type="text" value="" name="clerk_en_name" id="clerk_en_name" class="input-txt">
                    <span class="err"></span>
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="clerk_passwd"><em>*</em>业务员密码</label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="clerk_re_passwd"><em>*</em>确认密码</label>
                </dt>
                <dd class="opt">
...
$(function(){
    ...
    $('#clerk_form').validate({
        ...
        messages : {
            ...
            clerk_re_passwd:{
                required : '<i class="fa fa-exclamation-circle"></i><?php echo "确认密码不能为空";?>',
