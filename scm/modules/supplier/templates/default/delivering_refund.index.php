...
<div class="page">
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            <li><?php echo "您可以查看合作终端店已经申请退货的订单状态";?></li>
...
<script>
    $(function(){
        $("#flexigrid").flexigrid({
            url:'index.php?act=delivering_refund&op=get_xml',
            colModel:[
                ...
                {display: '发货日期', name : 'out_date', width : 120, sortable : true, align: 'center'},
                {display: '订单状态', name : 'order_status', width : 80, sortable : false, align: 'center'},
                {display: '发货状态', name : 'out_flag', width : 80, sortable : false, align: 'center'},
                {display: '终端店入库状态', name : 'in_flag', width : 100, sortable : false, align: 'center'},
                {display: '退货状态', name : 'refund_flag', width : 100, sortable : false, align: 'center'},
            ],
            buttons:[
