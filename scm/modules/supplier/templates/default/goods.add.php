    ...
    <form id="goods_form" enctype="multipart/form-data" method="post">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" id="goods_price" name="goods_price"  style="width: 100px;"> 元
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" id="goods_discount" name="goods_discount" style="width: 100px;">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" id="unit_num" name="unit_num" style="width: 100px;">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" id="production_date" name="production_date" class="input-txt" />
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" id="valid_remind" name="valid_remind" style="width: 100px;"> 天
                    <span class="err"></span>
                </dd>
            </dl>
            <dl class="row">
