...
<script>
    $(function(){
        $("#flexigrid").flexigrid({
            url:'index.php?act=delivered_refund&op=get_xml',
            colModel:[
                {display: '操作', name : 'operation', width : 150, sortable : false, align: 'center', className: 'handle'},
                {display: '序号', name : 'number', width : 50, sortable : false, align: 'center'},
                {display: '退单号', name : 'refunnd_no', width : 150, sortable : false, align: 'center'},
                ...
                {display: '供应商名称', name : 'clie_ch_name', width : 80, sortable : false, align: 'center'},
