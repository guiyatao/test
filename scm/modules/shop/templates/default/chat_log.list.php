...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>发送人即发出消息的会员，接收人为收到消息的会员，如果是商城的客服或管理员可显示所属商城名称。</li>
...
$(function(){
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '发送商城', name : 'f_store_name', width : 60, sortable : false, align: 'left'},
            {display: '发送商城ID', name : 'f_store_id', width : 80, sortable : false, align: 'left'},
            ...
            {display: '接收商城', name : 't_store_name', width : 60, sortable : false, align: 'left'},
            {display: '接收商城ID', name : 't_store_id', width : 80, sortable : false, align: 'left'},
