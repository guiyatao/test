...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      ...
      <li>列表一为时间段内进行中的团购活动息</li>
      <li>列表二为时间段内团购活动生成的有效订单记录，默认按照“下单商品数”降序排列</li>
    </ul>
  </div>
...
function update_flex(){
    ...
    $("#glist").flexigrid({
        ...
        colModel : [
            ...
            {display: '团购名称', name : 'groupbuy_name', width : 150, sortable : false, align: 'left'},
            ...
            {display: '团购状态', name : 'groupbuy_state_text',  width : 60, sortable : true, align: 'center'},
            ...
            {display: '团购价', name : 'groupbuy_price',  width : 60, sortable : true, align: 'center'},
        ...
        searchitems : [
            {display: '团购名称', name : 'groupbuy_name'},
...
$(function () {
	...
	$("[name='searchweek_month']").change(function(){
		...
		$.getJSON('<?php echo SCM_SITE_URL?>/index.php?act=common&op=getweekofmonth',{y:year,m:month},function(data){
	        if(data != null){
