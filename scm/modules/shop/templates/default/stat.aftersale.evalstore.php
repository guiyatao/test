...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>统计列表为符合条件商城的动态评分信息列表，并可以点击列表上方的“导出数据”将列表数据导出为Excel文件</li>
      ...
      <div id="searchCon" class="content">
        <div class="layout-box">
          <dl>
            ...
            <dd>
              <label>
                <input class="s-input-txt" type="text" value="<?php echo $output['search_arr']['storename'];?>" id="storename" name="storename" placeholder="请输入商城名称" />
              </label>
            </dd>
          </dl>
          <dl>
...
function update_flex(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '商城名称', name : 'seval_storename', width : 150, sortable : false, align: 'center'},
