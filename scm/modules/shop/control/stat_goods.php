...
class stat_goodsControl extends SCMControl{
    private $links = array(
    ...
    public function goods_saleOp(){
        ...
        $field = 'goods_id,min(goods_name) as goods_name,min(store_id) as store_id,min(goods_commonid) as goods_commonid,SUM(goods_num) as goodsnum,COUNT(DISTINCT order_id) as ordernum,SUM(goods_pay_price) as goodsamount';
