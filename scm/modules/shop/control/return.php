...
class returnControl extends SCMControl{
            ...
            if(!empty($return_info['pic_info'])) {
                ...
                if (is_array($info) && !empty($info['buyer'])) {
                    foreach($info['buyer'] as $pic_name) {
                        if(!empty($pic_name)) {
                            $list['pic_info'] .= "<a href='".$pic_base_url.
                            $pic_name."' target='_blank' class='pic-thumb-tip' onMouseOut='toolTip()' onMouseOver='toolTip(\"<img src=".
                            $pic_base_url.$pic_name.">\")'><i class='fa fa-picture-o'></i></a> ";
                        }
                    }
        ...
        foreach ($return_list as $k => $return_info) {
            ...
            if(!empty($return_info['pic_info'])) {
                ...
                if (is_array($info) && !empty($info['buyer'])) {
                    foreach($info['buyer'] as $pic_name) {
                        if(!empty($pic_name)) {
                            $list['pic_info'] .= "<a href='".$pic_base_url.$pic_name.
...
//                'store_id'  => '商家ID'
        ...
        \Shopnc\Lib::exporter()->output('return' .$_GET['curpage'] . '-'.date('Y-m-d'), $data, $header);
    }
}
