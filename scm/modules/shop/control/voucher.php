...
class voucherControl extends SCMControl{
    ...
    public function settingOp(){
        ...
        if (chksubmit()){
            ...
            $update_array['promotion_voucher_buyertimes_limit'] = $promotion_voucher_buyertimes_limit > 20?20:$promotion_voucher_buyertimes_limit;
