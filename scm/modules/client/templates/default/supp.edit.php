...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=supp_manage&op=index" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>供应商管理 - <?php echo $lang['nc_edit'];?>”<?php echo $output['supp_info']['supp_ch_name']?>“</h3>
        <h5>供应商信息管理</h5>
      </div>
    </div>
  </div>
  <form id="post_form" method="post" name="form1">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="help_title"><em>*</em>供应商名称</label>
        </dt>
        <dd class="opt">
          <input id="help_title" name="help_title" value="<?php echo $output['supp_info']['supp_ch_name']?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
