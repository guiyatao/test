...
<form method="post" name="form1" id="form1" action="<?php echo urlSCMClient('client_storage', 'storage_confirm');?>">
  <input type="hidden" name="form_submit" value="ok" />
  <input type="hidden" value="<?php echo $output['common_info']['id'];?>" name="order_id">
