...
<div class="page">
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            <li>1、统计图展示了已接受订单的下单金额和下单数量在时间段内的走势情况及与前一个时间段的趋势对比</li>
            <li>2、统计表显示了符合搜索条件的已接受订单列表并可以点击“导出Excel”将订单记录导出为Excel文件</li>
            <li>总下单金额：<strong><?php echo $output['statcount_arr']['orderamount'];?></strong>元&nbsp;&nbsp;&nbsp;&nbsp;总下单数量：<strong><?php echo $output['statcount_arr']['ordernum'];?></strong> </li>
        </ul>
    </div>
    ...
    <form  method="get" action="index.php" target="_self">
        <table class="search-form">
            ...
            <input type="hidden" name="op" value="order_amount" />
            <tr>
                <td class="tr">
                    <div class="fr">
