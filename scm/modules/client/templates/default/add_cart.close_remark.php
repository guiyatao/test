...
<form method="post" name="form1" id="form1" action="<?php echo urlSCMClient('client_purchase', 'add_cart');?>">
  ...
  <dl class="row">
      ...
      <dl class="row">
      <dt class="tit">供应商名称</dt><dd class="opt"><?php echo $output['common_info']['supp_ch_name'];?></dd></dl>
      <dl class="row">
