...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=accept_order&op=get_xml',
        colModel : [
        ...
        searchitems : [
            {display: '订单编号', name : 'scm_online_order.order_sn', isdefault: true},
            {display: '买家姓名', name : 'scm_online_order.buyer_name'},
            {display: '买家电话', name : 'scm_online_order.buyer_phone'}
            ],
        sortname: "order_id",
        sortorder: "desc",
        title: '未接受订单列表'
