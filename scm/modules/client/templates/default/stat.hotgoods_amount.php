...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3>热门商品</h3>
                <h5>显示当前终端店的下单商品金额排名前30位的商品曲线图。</h5>
            </div>
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            ...
            <li>2、图表展示了符合搜索条件的有效订单中的下单商品金额排名前30位的商品</li>
        </ul>
    </div>
    ...
    <form  method="get" action="index.php" target="_self">
        <table class="search-form">
            ...
            <input type="hidden" name="op" value="hotgoods_amount" />
            <tr>
                <td class="tr">
                    <div class="fr">
    ...
    <!-- 下单商品金额 -->
    <div id="goods_amount_div">
        <div id="container_goods_amount" style="width:930px;"></div>
        <div style="width:930px;">
            <table class="ncsc-default-table">
                ...
                <tbody>
                <?php if (!empty($output['statlist']['goods_amount']) && is_array($output['statlist']['goods_amount'])) { ?>
                    <?php foreach($output['statlist']['goods_amount'] as $k=>$v) { ?>
                        <tr class="bd-line">
                            <td><?php echo $k+1; ?></td>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#container_goods_amount').highcharts(<?php echo $output['stat_json']['goods_amount'];?>);
