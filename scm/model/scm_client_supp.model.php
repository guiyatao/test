...
class scm_client_suppModel extends Model{
     ...
     * @return array
     */
    public function getSuppList($condition = array(), $page = '', $limit = '', $fields = '*', $order = 'supp_id desc') {
        $on = 'scm_client_supp.supp_id = scm_supplier.supp_id';
        $result = $this->table('scm_client_supp,scm_supplier')->field($fields)->join('inner')->on($on)->where($condition)->page($page)->limit($limit)->order($order)->select();
        return $result;
    }
     ...
     * @return array
     */
    public function getSuppInfo($condition = array(), $page = '', $limit = 0) {
        $result = $this->table('scm_supplier')->where($condition)->page($page)->limit($limit)->select();
        return $result;
    }
     ...
     * @return array
     */
    public function getSupplierList($condition = array(), $page = '', $order = 'scm_supplier.supp_id desc') {
