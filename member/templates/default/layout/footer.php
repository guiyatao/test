    ...
    <ul>
      ...
      <li>
        <dl class="s<?php echo ''.$k+1;?>">
          ...
          <dd><i></i><a href="<?php if($article['article_url'] != '')echo $article['article_url'];else echo urlMember('article', 'show',array('article_id'=> $article['article_id']));?>" title="<?php  if($article['article_title'] =='关于ShopNC') {echo '关于共铸商城';} else{echo $article['article_title'];} ?>"> <?php if($article['article_title'] =='关于ShopNC') {echo '关于共铸商城';} else{echo $article['article_title'];} ?> </a></dd>
          <?php }?>
          <?php }?>
        </dl>
      </li>
