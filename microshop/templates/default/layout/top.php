...
<meta name="author" content="共铸商城">
<meta name="copyright" content="共铸商城 Inc. All Rights Reserved">
  ...
  <div id="navBox">
    ...
    <div class="microMall-user">
      ...
      <ul class="sub-menu">
        ...
        <?php } else { ?>
        <li class="no-sub pngFix"><a href="<?php echo urlLogin('login', 'index');?>"><?php echo $lang['nc_login'];?></a></li>
        <?php } ?>
