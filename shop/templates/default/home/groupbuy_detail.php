...
<div class="nch-breadcrumb-layout" style="display: block;">
  <div class="nch-breadcrumb wrapper"> <i class="icon-home"></i> <span> <a href="<?php echo urlShop(); ?>">首页</a> </span> <span class="arrow">></span>
    ...
    <span><a href="<?php echo urlShop('show_groupbuy', 'vr_groupbuy_list'); ?>">虚拟团</a></span>
    <?php } else { ?>
    <span><a href="<?php echo urlShop('show_groupbuy', 'groupbuy_list'); ?>">线上团</a></span>
    <?php } ?>
      ...
      <div class="ncg-instructions">
        ...
        <ul>
          <li> 1. 本次团购活动的最终有效期至
            ...
            <?php } ?>
            。 </li>
          <li>2. 消费团购兑换码/券时，请向商家提供系统发送的“虚拟团购兑换码”，一码一销。</li>
          <?php if ($output['buy_limit'] > 0) { ?>
          <li>3. 单人每笔订单最多团购<strong><?php echo $output['buy_limit']; ?></strong>个兑换码/券，如需更多请再次购买。</li>
          <?php } ?>
        </ul>
      </div>
      <?php } ?>
