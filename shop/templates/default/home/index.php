...
<div class="home-focus-layout"> <?php echo $output['web_html']['index_pic'];?>
  <div class="right-sidebar">
    ...
    <div class="proclamation">
      ...
      <div class="tabs-panel"> <a href="#" title="共铸商城" class="store-join-btn" >&nbsp;</a> <a href="<?php echo urlShop('seller_login','show_login');?>" target="_blank" class="store-join-help"><i class="icon-cog"></i>登录运营管理中心</a> </div>
...
<div class="wrapper">
  <div class="mt10">
    <div class="mt10"> <a title="物流自提服务站广告" target="_blank" href="<?php echo DELIVERY_SITE_URL;?>"> <img border="0" alt="物流自提服务站广告" src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_DELIVERY;?>/adv/banner.gif" style="width:1200px;height:100px"> </a> </div>
  </div>
</div>
