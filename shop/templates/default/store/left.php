...
<div class="ncs-sidebar-container ncs-top-bar">
  ...
  <div class="content">
    <ul class="ncs-top-tab pngFix">
      <li id="hot_sales_tab" class="current"><a href="#"><?php echo $lang['nc_hot_goods_rankings'];?></a></li>
      <li id="hot_collect_tab"><a href="#"><?php echo $lang['nc_hot_collect_rankings'];?></a></li>
    </ul>
