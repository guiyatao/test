  ...
  <table class="ncc-table-style">
    ...
    <tbody>
      ...
      <?php foreach($cart_list as $cart_info) {
          $goodsids[] = $cart_info['goods_id'].'|'.$cart_info['goods_num'];
          $goodscnt[]= $cart_info['goods_num'];
      ?>
...
>
      ...
      <tr>
        <td colspan="20"><div class="ncc-msg">买家留言：
            ...
            <div class="choosestore" style="padding-top:5px">
                <input type="hidden" value="" id="storecnt"/>
                <span style="color:red">*</span>&nbsp;<input type="radio" name="order_pickup_type" value="1" class="choosetype" id="choose_self_pickup">自提 &nbsp; <input type="radio" name="order_pickup_type" value="2" selected class="choosetype" id="choose_send_by_store">送货
                <div class="choose_store_row" style="padding-top:5px;display:none;">
                    <table>
                        <tr>
                            <td>
                                <span id="storemsg" class="red" style="color:red"></span>
                                <span class="label">门店:</span>
        						<input type="hidden" value = "<?php echo implode(",",$goodsids) ?>" id="order_pickup_goodsids" />
        						<input type="hidden" value= "<?php echo implode(",",$goodscnt) ?>" id="order_pickup_goodscnt"/>				
                            </td>
                            <td>
                                <select id="order_pickup_store" name="order_pickup_store">
...
$(function() {
    ...
    $("#choose_self_pickup").click(function(){
        
    	$(".choose_store_row .label").show();
    	$(".choose_store_row #order_pickup_store").show();
    	$("#addressmsg").show();
    	ableSubmitOrder();
    });    
    $("#choose_send_by_store").click(function(){
    	$(".choose_store_row .label").hide();
    	$(".choose_store_row #order_pickup_store").hide();
    	$("#addressmsg").hide();
    	ableSubmitOrder();
    });    
