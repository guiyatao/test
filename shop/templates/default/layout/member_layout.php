        ...
        <div class="ncm-header-top">
            <div class="ncm-member-info">
                <div class="avatar"><a href="<?php echo urlMember('member_information', 'avatar'); ?>" title="修改头像"><img
                    ...
                    <?php if (intval($output['message_num']) > 0) { ?>
                        <a href="<?php echo MEMBER_SITE_URL ?>/index.php?act=member_message&op=message"
                           class="new-message" title="新消息"><?php echo intval($output['message_num']); ?></a>
                    <?php } ?>
                </div>
                <dl>
                    <dt><a href="<?php echo urlMember('member_information', 'member'); ?>"
                           title="修改资料"><?php echo $output['member_info']['member_name']; ?></a></dt>
                    <dd>会员等级：
                        ...
                        <div class="user-account">
                            <ul>
                                ...
                                <li id="points"><a href="<?php echo urlMember('member_points', 'index'); ?>"
                                        ...
                                        <span class="icon"></span></a></li>
                                <li id="voucher"><a href="<?php echo urlMember('member_voucher', 'index'); ?>"
                                                    title="我的代金券：<?php echo $output['member_info']['voucher_count']; ?>张">
                                        <span class="icon"></span></a></li>
                                <li id="envelope"><a href="<?php echo urlMember('member_redpacket', 'index'); ?>"
                                                     title="我的红包：<?php echo $output['member_info']['redpacket_count']; ?>张">
                                        <span class="icon"></span></a></li>
                            </ul>
                        </div>
                    </dd>
            ...
            <div class="ncm-trade-menu">
                ...
                <ul class="trade-function-01">
                    ...
                    <!--                    <li><a href="-->
                    <?php //echo urlShop('member_favorite_store', 'index'); ?><!--"><span class="tf02"></span>-->
                    <!--                            <h5>店铺</h5>-->
                    <!--                        </a></li>-->
                ...
                <li><a href="<?php echo urlShop('member_snshome', 'index') ?>">个人主页<i></i></a>
                    <div class="sub-menu">
                        <dl>
                            ...
                            <!--                            <dd><a href="-->
                            <?php //echo urlShop('member_snshome', 'storelist'); ?><!--">分享店铺</a></dd>-->
                        </dl>
                    </div>
                </li>
                <li><a href="javascript:;">其他应用<i></i></a>
                    <div class="sub-menu">
                        <dl>
                            ...
                            <dd>
                                <a href="<?php echo urlMicroshop('home', 'index', array('member_id' => $_SESSION['member_id'])); ?>">我的微商城</a>
                            </dd>
                        </dl>
                    </div>
                </li>
        ...
        <ul id="sidebarMenu" class="ncm-sidebar">
            <?php if (!empty($output['menu_list'])) { ?>
                <?php foreach ($output['menu_list'] as $key => $value) { ?>
                    <li class="side-menu"><a href="javascript:void(0)"
                                             key="<?php echo $key; ?>" <?php if (cookie('Mmenu_' . $key) == 1) echo 'class="shrink"'; ?>>
                            <h3><?php echo $value['name']; ?></h3>
                        </a>
                        <?php if (!empty($value['child'])) { ?>
                            <ul <?php if (cookie('Mmenu_' . $key) == 1) echo 'style="display:none"'; ?>>
                                <?php foreach ($value['child'] as $key => $val) { ?>
                                    <li <?php if ($key == $output['act']) { ?>class="selected"<?php } ?>><a
                                            href="<?php echo $val['url']; ?>"><?php echo $val['name']; ?></a></li>
                                <?php } ?>
                            </ul>
                        <?php } ?>
                    </li>
