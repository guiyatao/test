  ...
  <div class="ncm-order-info">
    <div class="ncm-order-details">
      ...
      <div class="content">
        ...
        <?php if ($output['client_address_phone']) {?>
        <dl class="line">
          <dt>提货地址：</dt>
            <dd>
                <?php echo $output['client_address_phone'];?>
            </dd>
        </dl>    
        <?php }?>    
        <dl>
    ...
    <div class="ncm-order-condition">
      ...
      <ul>
        ...
        <li>2. 将感兴趣的<a href="index.php?act=member_favorite_goods&op=fglist" class="ncbtn-mini ncbtn-grapefruit">收藏商品</a>加入购物车进行购买。</li>
<!--        <li>3. 看一看<a href="--><?php //echo urlShop('show_store','index',array('store_id'=>$output['order_info']['store_id']), $output['order_info']['extend_store']['store_domain']);?><!--" class="ncbtn-mini ncbtn-grapefruit">该店铺</a>中有什么新商品上架。</li>-->
      </ul>
    </div>
    <?php } else { ?>
    <div class="ncm-order-condition">
      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <td><!-- 退款 -->
            ...
            <?php if ($goods['refund'] == 1&&$output['order_info']['order_state']!=40){?>
