...
(15, 9, '首页通栏', 'a:2:{s:7:"adv_pic";s:21:"04418235791378401.jpg";s:11:"adv_pic_url";s:14:"www.shopnc.net";}', 1388505600, 1577721600, 0, 0, '', 0, 1, '', 0);
...
(6, 2, '', 1, 1, 255, '如何注册成为会员', '如何注册成为会员', 1432522192),
(7, 2, '', 1, 1, 255, '如何搜索', '如何搜索', 1432522192),
(8, 2, '', 1, 1, 255, '忘记密码', '忘记密码', 1432522192),
(9, 2, '', 1, 1, 255, '我要买', '我要买', 1432522192),
(10, 2, '', 1, 1, 255, '查看已购买商品', '查看已购买商品', 1432522192),
(11, 3, '', 1, 1, 255, '如何管理店铺', '如何管理店铺', 1432522192),
(12, 3, '', 1, 1, 255, '查看售出商品', '查看售出商品', 1432522192),
(13, 3, '', 1, 1, 255, '如何发货', '如何发货', 1432522192),
(14, 3, '', 1, 1, 255, '商城商品推荐', '商城商品推荐', 1432522192),
(15, 3, '', 1, 1, 255, '如何申请开店', '如何申请开店', 1432522192),
(16, 4, '', 1, 1, 255, '如何注册支付宝', '如何注册支付宝', 1432522192),
(17, 4, '', 1, 1, 255, '在线支付', '在线支付', 1432522192),
(18, 6, '', 1, 1, 255, '会员修改密码', '会员修改密码', 1432522192),
(19, 6, '', 1, 1, 255, '会员修改个人资料', '会员修改个人资料', 1432522192),
(20, 6, '', 1, 1, 255, '商品发布', '商品发布', 1432522192),
(21, 6, '', 1, 1, 255, '修改收货地址', '修改收货地址', 1432522192),
(22, 7, '', 1, 1, 255, '关于ShopNC', '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 天津市网城天创科技有限责任公司位于天津市红桥区，是专业从事生产管理信息化领域技术咨询和软件开发的高新技术企业。公司拥有多名技术人才和资深的行业解决方案专家。</p>\r\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 公司拥有一支勇于开拓、具有战略眼光和敏锐市场判断力的市场营销队伍，一批求实敬业，追求卓越的行政管理人才，一个能征善战，技术优秀，经验丰富的开发团队。公司坚持按现代企业制度和市场规律办事，在扩大经营规模的同时，注重企业经济运行质量，在自主产品研发及承接软件项目方面获得了很强的竞争力。 我公司也积极参与国内传统企业的信息化改造，引进国际化产品开发的标准，规范软件开发流程，通过提升各层面的软件开发人才的技术素质，打造国产软件精品，目前已经开发出具有自主知识产权的网络商城软件，还在积极开发基于电子商务平台高效能、高效益的管理系统。为今后进一步开拓国内市场打下坚实的基础。公司致力于构造一个开放、发展的人才平台，积极营造追求卓越、积极奉献的工作氛围，把“以人为本”的理念落实到每一项具体工作中，为那些锋芒内敛，激情无限的业界精英提供充分的发展空间，优雅自信、从容自得的工作环境，事业雄心与生活情趣两相兼顾的生活方式。并通过每个员工不断提升自我，以自己的独特价值观对工作与生活作最准确的判断，使我们每一个员工彰显出他们出色的自我品位，独有的工作个性和卓越的创新风格，让他们时刻保持振奋、不断鼓舞内心深处的梦想，永远走在时代潮流前端。公司发展趋势 励精图治，展望未来。公司把发展产业策略与发掘人才策略紧密结合，广纳社会精英，挖掘创新潜能，以人为本，凝聚人气，努力营造和谐宽松的工作氛围，为优秀人才的脱颖而出提供机遇。公司将在深入发展软件产业的同时，通过不懈的努力，来塑造大型软件公司的辉煌形象。 </p>', 1432522192),
(23, 7, '', 1, 1, 255, '联系我们', '<p>欢迎您对我们的站点、工作、产品和服务提出自己宝贵的意见或建议。我们将给予您及时答复。同时也欢迎您到我们公司来洽商业务。</p>\r\n<p><br />\r\n<strong>公司名称</strong>： 天津市网城天创科技有限责任公司 <br />\r\n<strong>通信地址</strong>： 天津市和平区南马路创新大厦A座12层 <br />\r\n<strong>邮政编码</strong>： 300121 <br />\r\n<strong>电话</strong>： 400-880-1509 <br />\r\n<strong>商务洽谈</strong>： 86-022-58306929 <br />\r\n<strong>软件著作权登记号</strong>： 软著登字第0650314号 <br />\r\n<strong>ICP备案号</strong>： 津ICP备10001600号 </p>', 1432522192),
(24, 7, '', 1, 1, 255, '招聘英才', '<dl> <h3>PHP程序员</h3>\r\n<dt>职位要求： <dd>熟悉PHP5开发语言；<br />\r\n熟悉MySQL5数据库，同时熟悉sqlserver，oracle者优先；<br />\r\n熟悉面向对象思想，MVC三层体系，至少使用过目前已知PHP框架其中一种；<br />\r\n熟悉SERVER2003/Linux操作系统，熟悉常用Linux操作命令；<br />\r\n熟悉Mysql数据库应用开发，了解Mysql的数据库配置管理、性能优化等基本操作技能；<br />\r\n熟悉jquery，smarty等常用开源软件；<br />\r\n具备良好的代码编程习惯及较强的文档编写能力；<br />\r\n具备良好的团队合作能力；<br />\r\n熟悉设计模式者优先；<br />\r\n熟悉java，c++,c#,python其中一种者优先； </dd> <dt>学历要求： <dd>大本 </dd> <dt>工作经验： <dd>一年以上 </dd> <dt>工作地点： <dd>天津 </dd></dl> <dl> <h3>网页设计（2名）</h3>\r\n<dt>岗位职责： <dd>网站UI设计、 切片以及HTML制作。 </dd> <dt>职位要求： <dd>有大型网站设计经验；有网站改版、频道建设经验者优先考虑； <br />\r\n熟练掌握photoshop,fireworks,dreamwaver等设计软件； <br />\r\n熟练运用Div+Css制作网页，符合CSS2.0-W3C标准，并掌握不同浏览器下，不同版本下CSS元素的区别；<br />\r\n熟悉网站制作流程，能运用并修改简单JavaScript类程序； <br />\r\n积极向上，有良好的人际沟通能力，良好的工作协调能力，踏实肯干的工作精神；具有良好的沟通表达能力，<br />\r\n需求判断力，团队协作能力； <br />\r\n请应聘者在简历中提供个人近期作品连接。 </dd> <dt>学历要求： <dd>专科 </dd> <dt>工作经验： <dd>一年以上 </dd> <dt>工作地点： <dd>天津 </dd></dl> <dl> <h3>方案策划（1名）</h3>\r\n<dt>职位要求： <dd>2年以上的文案编辑类相关工作经验，具备一定的文字功底，有极强的语言表达和逻辑思维能力， 能独立完成项目方案的编写，拟草各种协议。熟悉使用办公软件。 </dd> <dt>学历要求： <dd>大专以上 </dd> <dt>工作经验： <dd>一年以上 </dd> <dt>工作地点： <dd>天津 </dd></dl>', 1432522192),
(25, 7, '', 1, 1, 255, '合作及洽谈', '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ShopNC希望与服务代理商、合作伙伴并肩合作，携手开拓日益广阔的网络购物软件市场。如果您拥有好的建议，拥有丰富渠道资源、拥有众多目标客户、拥有相应的市场资源，并希望与ShopNC进行深度业务合作， 欢迎成为ShopNC业务合作伙伴，请联系。</p>\r\n<p>&nbsp;</p>\r\n<p><strong>公司名称</strong>： 天津市网城天创科技有限责任公司 <br />\r\n<strong>通信地址</strong>： 天津市和平区南马路创新大厦A座12层 <br />\r\n<strong>邮政编码</strong>： 300121 <br />\r\n<strong>电话</strong>： 400-880-1509 <br />\r\n<strong>商务洽谈</strong>： 86-022-58306929 <br />\r\n</p>', 1432522192),
(26, 5, '', 1, 1, 255, '联系卖家', '联系卖家', 1432522192),
(28, 4, '', 1, 1, 255, '分期付款', '分期付款<br />', 1432522192),
(29, 4, '', 1, 1, 255, '邮局汇款', '邮局汇款<br />', 1432522192),
(30, 4, '', 1, 1, 255, '公司转账', '公司转账<br />', 1432522192),
(31, 5, '', 1, 1, 255, '退换货政策', '退换货政策', 1432522192),
(32, 5, '', 1, 1, 255, '退换货流程', '退换货流程', 1432522192),
(33, 5, '', 1, 1, 255, '返修/退换货', '返修/退换货', 1432522192),
(34, 5, '', 1, 1, 255, '退款申请', '退款申请', 1432522192),
(35, 1, 'http://www.shopnc.net/', 1, 1, 1, '火爆销售中', '火爆销售中<br />', 1432522192),
(36, 1, '', 1, 1, 255, '管理功能说明', '管理功能说明', 1432522192),
(37, 1, '', 1, 1, 255, '如何扩充水印字体库', '如何扩充水印字体库', 1432522192),
(38, 1, '', 1, 1, 255, '提示信息', '提示信息', 1432522192),
(39, 2, '', 1, 1, 255, '积分细则', '积分细则积分细则', 1432522192),
(40, 2, '', 1, 1, 255, '积分兑换说明', '积分兑换说明', 1432522192),
(41, 1, '', 1, 1, 255, '功能使用说明', '功能使用说明', 1432522192);
...
(6, 0, '关于ShopNC', 'member/index.php?act=article&article_id=22', 2, 0, 255, 0),
...
(1, '{sitename} - Powered by ShopNC', 'ShopNC,PHP商城系统,ShopNC商城系统,多用户商城系统,电商ERP,电商CRM,电子商务解决方案', 'ShopNC专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'index'),
(2, '{sitename} - 团购', 'ShopNC,{sitename}', 'ShopNC专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'group'),
(3, '{sitename} - {name}', 'ShopNC,{name},{sitename}', 'ShopNC,{name},{sitename}', 'group_content'),
(4, '{sitename} - 品牌', 'ShopNC,{sitename}', 'ShopNC,{sitename}', 'brand'),
(5, '{sitename} - {name}', 'ShopNC,{sitename},{name}', 'ShopNC,{sitename},{name}', 'brand_list'),
(7, '{sitename} - {name}', 'ShopNC,{sitename},{name}', 'ShopNC,{sitename},{name}', 'coupon_content'),
(8, '{sitename} - 积分商城', 'ShopNC,{sitename}', 'ShopNC,{sitename}', 'point'),
(9, '{sitename} - {name}', 'ShopNC,{sitename},{key}', 'ShopNC,{sitename},{description}', 'point_content'),
(10, '{sitename} - {article_class}', 'ShopNC,{sitename}', 'ShopNC,{sitename}', 'article'),
(11, '{sitename} - {name}', 'ShopNC,{sitename},{key}', 'ShopNC,{sitename},{description}', 'article_content'),
(12, '{sitename} - {shopname}', 'ShopNC,{sitename},{key}', 'ShopNC,{sitename},{description}', 'shop'),
(13, '{name} - {sitename}', 'ShopNC,{sitename}', 'ShopNC,{sitename}', 'product'),
(14, '看{name}怎么淘到好的宝贝-{sitename}', 'ShopNC,{sitename},{name}', 'ShopNC,{sitename},{name}', 'sns');
...
(1, '红色', 'red', 'index', 1432522192, 1, 0, NULL),
(2, '女装/男装/内衣', 'pink', 'index', 1419819162, 1, 1, NULL),
(3, '橘色', 'orange', 'index', 1432522192, 2, 0, NULL),
(4, '绿色', 'green', 'index', 1432522192, 3, 0, NULL),
(5, '蓝色', 'blue', 'index', 1432522192, 4, 0, NULL),
(6, '紫色', 'purple', 'index', 1432522192, 6, 0, NULL),
(7, '褐色', 'brown', 'index', 1432522192, 7, 0, NULL),
(8, '默认', 'default', 'index', 1432522192, 8, 0, NULL),
