...
CREATE TABLE `#__cms_article` (
  ...
  `article_comment_count` int(10) unsigned NULL DEFAULT '0' COMMENT '文章评论数',
...
CREATE TABLE `#__cms_comment` (
  ...
  `comment_up` int(10) unsigned NULL DEFAULT '0' COMMENT '顶数量',
...
INSERT INTO `#__cms_module` (`module_id`, `module_title`, `module_name`, `module_type`, `module_class`) VALUES
...
INSERT INTO `#__cms_module_assembly` (`assembly_id`, `assembly_title`, `assembly_name`, `assembly_explain`) VALUES
(1, '文章', 'article', '文章组件'),
(2, '图片', 'picture', '图片组件'),
(3, '商品', 'goods', '商品组件'),
(4, '品牌', 'brand', '品牌组件'),
...
INSERT INTO `#__cms_module_frame` (`frame_id`, `frame_title`, `frame_name`, `frame_explain`, `frame_structure`) VALUES
...
INSERT INTO `#__cms_navigation` (`navigation_id`, `navigation_title`, `navigation_link`, `navigation_sort`, `navigation_open_type`) VALUES
(1, '商城', '', 255, 1),
(2, '圈子', 'circle', 255, 1),
(3, '微商城', 'microshop', 255, 1),
(4, '品牌', 'shop/index.php?act=brand', 255, 1);
...
CREATE TABLE `#__cms_picture` (
  ...
  `picture_comment_count` int(10) unsigned NULL DEFAULT '0' COMMENT '画报评论数',
  `picture_title_short` varchar(50) NULL DEFAULT '' COMMENT '画报短标题',
  `picture_image_count` tinyint(1) unsigned NULL DEFAULT '0'COMMENT '画报图片总数',
  `picture_share_count` int(10) unsigned NULL DEFAULT '0' COMMENT '画报分享数',
