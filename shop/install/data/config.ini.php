...
$config['db']['master']['dbhost']       = '===db_host===';
$config['db']['master']['dbport']       = '===db_port===';
$config['db']['master']['dbuser']       = '===db_user===';
$config['db']['master']['dbpwd']        = '===db_pwd===';
$config['db']['master']['dbname']       = '===db_name===';
$config['db']['master']['dbcharset']    = '===db_charset===';
