...
//            {display: '商城', name : 'store_id', width : 60, sortable : true, align: 'center'},
//            {display: '商城名称', name : 'store_name', width : 80, sortable : true, align: 'left'},
//            {display: '商城类型', name : 'is_own_shop', width : 80, sortable : true, align: 'center'},
