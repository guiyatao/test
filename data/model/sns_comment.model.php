...
class sns_commentModel extends Model {
    ...
    public function commentAdd($param){
        ...
        if (is_array($param)){
            $result = $this->insert1('sns_comment',$param);
            return $result;
        }else {
            return false;
        }
    ...
    public function getCommentCount($condition){
        $condition_str  = $this->getCondition($condition);
        return $this->getCount1("sns_comment",$condition_str);
    }
    /**
     * 获取评论详细
     *
    ...
    public function delComment($condition){
        ...
        return $this->delete1('sns_comment',$condition_str);
    }
    /**
     * 更新评论记录
    ...
    public function commentEdit($param,$condition){
        ...
        //得到条件语句
        $condition_str  = $this->getCondition($condition);
        $result = $this->update1('sns_comment',$param,$condition_str);
        return $result;
    }
    /**
     * 将条件数组组合为SQL语句的条件部分
