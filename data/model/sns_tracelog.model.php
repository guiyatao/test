...
class sns_tracelogModel extends Model {
    ...
    public function tracelogAdd($param){
        ...
        $result = $this->insert1('sns_tracelog',$param);
        return $result;
    }
    /**
     * 动态记录列表
    ...
    public function tracelogEdit($param,$condition){
        ...
        //得到条件语句
        $condition_str  = $this->getCondition($condition);
        $result = $this->update1('sns_tracelog',$param,$condition_str);
        return $result;
    }
    /**
     * 删除动态
    ...
    public function delTracelog($condition){
        ...
        return $this->delete1('sns_tracelog',$condition_str);
    }
    /**
     * 动态总数
     */
    public function countTrace($condition){
        //得到条件语句
        $condition_str  = $this->getCondition($condition);
        $count = $this->getCount1('sns_tracelog',$condition_str);
        return $count;
    }
    /**
     * 将条件数组组合为SQL语句的条件部分
