...
class sns_friendModel extends Model {
    ...
    public function addFriend($param) {
        ...
        if (is_array($param)){
            $result = $this->insert1('sns_friend',$param);
            return $result;
        }else {
            return false;
        }
    ...
    public function listFriend($condition,$field='*',$obj_page='',$type='simple') {
        ...
        $friend_list    = $this->select1($param,$obj_page);
        return $friend_list;
    }
    /**
     * 获取好友详细
    ...
    public function countFriend($condition){
        //得到条件语句
        $condition_str  = $this->getCondition($condition);
        $count = $this->getCount1('sns_friend',$condition_str);
        return $count;
    }
    /**
     * 更新好友信息
    ...
    public function editFriend($param,$condition) {
        ...
        //得到条件语句
        $condition_str  = $this->getCondition($condition);
        $result = $this->update1('sns_friend',$param,$condition_str);
        return $result;
    }
    /**
     * 删除关注
    ...
    public function delFriend($condition){
        ...
        return $this->delete1('sns_friend',$condition_str);
    }
