...
class uploadModel extends Model {
    ...
    public function add($param){
        ...
        if (is_array($param)){
            $result = $this->insert1('upload',$param);
            return $result;
        }else {
            return false;
        }
    ...
    public function updates($param){
        ...
        if (is_array($param)){
            ...
            $result = $this->update1('upload',$tmp,$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function updatebywhere($param,$conditionarr){
        ...
        if (is_array($param)){
            ...
            $result = $this->update1('upload',$tmp,$condition_str);
            return $result;
        }else {
            return false;
        }
    ...
    public function del($id){
        if (intval($id) > 0){
            ...
            $result = $this->delete1('upload',$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function dropUploadById($id){
        ...
        $result = $this->delete1('upload',$condition_str);
        return $result;
    }
    /**
     * 删除图片信息，根据where
