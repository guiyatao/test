...
class cacheModel extends Model {
    ...
    private function _scm_menu() {
        ...
        if (file_exists(BASE_PATH.DS.SCM_MODULES_SUPPLIER.'/include/menu.php')) {
            require(BASE_PATH.DS.SCM_MODULES_SUPPLIER.'/include/menu.php');
        }
	
        if (file_exists(BASE_PATH.DS.SCM_MODULES_CLIENT.'/include/menu.php')) {
            require(BASE_PATH.DS.SCM_MODULES_CLIENT.'/include/menu.php');
        }

        if (file_exists(BASE_PATH.DS.SCM_MODULES_GZKJ.'/include/menu.php')) {
            require(BASE_PATH.DS.SCM_MODULES_GZKJ.'/include/menu.php');
        }
