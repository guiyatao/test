...
class albumModel extends Model{
    ...
    public function addClass($input){
        if(is_array($input) && !empty($input)){
            return $this->insert1('album_class',$input);
        }else{
            return false;
        }
    }
    ...
    public function updateClass($input,$id){
        if(is_array($input) && !empty($input)){
            return $this->update1('album_class',$input," aclass_id='$id' ");
        }else{
            return false;
        }
    }
    ...
    public function updatePic($input,$condition){
        if(is_array($input) && !empty($input)){
            return $this->update1('album_pic',$input,$this->getCondition($condition));
        }else{
            return false;
        }
    }
    ...
    public function delClass($id){
        if(!empty($id)) {
            return $this->delete1('album_class'," aclass_id ='".$id."' ");
        }else{
            return false;
        }
    }
    ...
    public function delAlbum($id){
        $id = intval($id);
        $this->delete1('album_class'," store_id= ".$id);
        ...
        $this->delete1('album_pic'," store_id= ".$id);
    }
    /**
     * 删除图片
     *
    ...
    public function delPic($id, $store_id){
        ...
        if(!empty($id)) {
            return $this->delete1('album_pic','apic_id in('.$id.')');
        }else{
            return false;
        }
    }
    ...
    public function getOneClass($param){
        if(is_array($param) && !empty($param)) {
            return $this->getRow1(array_merge(array('table'=>'album_class'),$param));
        }else{
            return false;
        }
    }
    ...
    public function getOnePicById($param){
        if(is_array($param) && !empty($param)) {
            return $this->getRow1(array_merge(array('table'=>'album_pic'),$param));
        }else{
            return false;
        }
    }
