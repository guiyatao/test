...
class advModel extends Model
{
    ...
    public function ap_add($param){
        ...
        if (is_array($param)){
            ...
            $result = $this->insert1('adv_position',$tmp);
            return $result;
        }else {
            return false;
        }
   ...
   /**
    ...
    public function ap_del($ap_id)
    {
        ...
        $result = $this->delete1("adv_position",$where);
        return $result;
    }
    /**
     * 获取广告位列表
    ...
    public function updates($param)
    {
        ...
        return $this->update1('adv',$param,"adv_id='{$param['adv_id']}'");
    }
    /**
     * 更新广告位记录
     *
    ...
    public function ap_update($param)
    {
        ...
        return $this->update1('adv_position',$param,"ap_id='{$param['ap_id']}'");
    }
    /**
     * 构造查询条件
     *
