...
class goods_class_tagModel extends Model{
    ...
    public function clearTag(){
        return $this->query("TRUNCATE TABLE ".C('tablepre')."goods_class_tag");
    }
    ...
    public function updateTag($param){
        ...
        if (is_array($param)){
            ...
            $result = $this->update1('goods_class_tag',$tmp,$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function delTagByIds($id){
        if(!empty($id)) {
            return $this->delete1('goods_class_tag',' gc_tag_id in ('.$id.')');
        }else{
            return false;
        }
    }
    ...
    public function delByCondition($condition){
        return $this->delete1('goods_class_tag', $this->_condition($condition));
    }
    ...
    public function addOneTag($param){
        ...
        if (is_array($param)){
            ...
            $result = $this->insert1('goods_class_tag',$tmp);
            return $result;
        }else {
            return false;
        }
