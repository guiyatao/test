...
class upload_albumModel extends Model {
    ...
    public function add($param){
        ...
        if (is_array($param)){
            $result = $this->insert1('album_pic',$param);
            return $result;
        }else {
            return false;
        }
    ...
    public function updates($param){
        ...
        if (is_array($param)){
            ...
            $result = $this->update1('album_pic',$tmp,$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function updatebywhere($param,$conditionarr){
        ...
        if (is_array($param)){
            ...
            $result = $this->update1('album_pic',$tmp,$condition_str);
            return $result;
        }else {
            return false;
        }
    ...
    public function del($id){
        if (intval($id) > 0){
            ...
            $result = $this->delete1('album_pic',$where);
            return $result;
        }else {
            return false;
        }
    ...
    public function dropUploadById($id){
        ...
        $result = $this->delete1('album_pic',$condition_str);
        return $result;
    }
    //
    //
