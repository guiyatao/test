...
class specModel extends Model {
    ...
    public function specList($param, $page = '', $field = '*') {
        ...
        $list_spec      = $this->select1($array, $page);
        return $list_spec;
    }
    /**
     * 单条规格信息
    ...
    public function specUpdate($update, $param, $table){
        ...
        if (is_array($update)){
            ...
            $result = $this->update1($table,$tmp,$condition_str);
            return $result;
        }else {
            return false;
        }
    ...
    public function specValueAdd($param){
        ...
        if (is_array($param)){
            ...
            $result = $this->insert1('spec_value',$tmp);
            return $result;
        }else {
            return false;
        }
    ...
    public function delSpec($table,$param){
        $condition_str = $this->getCondition($param);
        return $this->delete1($table, $condition_str);
    }
    /**
     * 将条件数组组合为SQL语句的条件部分
     *
