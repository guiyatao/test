<?php
define("SCM_SITE_URL", "http://localhost/scm");
$config = array();
...
$config['scm_site_url']         = 'http://localhost/scm';
$config['version']              = '2015091012636';
$config['setup_date']           = '2016-06-23 10:58:49';
$config['gip']                  = 0;
$config['dbdriver']             = 'mysql';
$config['tablepre']             = 'gzkj_';
$config['db']['master']['dbhost']       = '192.168.3.250';
$config['db']['master']['dbport']       = '3306';
$config['db']['master']['dbuser']       = 'cail';
$config['db']['master']['dbpwd']        = '123456';
$config['db']['master']['dbname']       = 'gzkj';
$config['db']['master']['dbcharset']    = 'UTF-8';
$config['db']['slave']                  = $config['db']['master'];
$config['session_expire']   = 3600;
$config['lang_type']        = 'zh_cn';
$config['cookie_pre']       = 'EB5F_';
