...
//             $this->_logic_buy_1->parseZhekou($goods_info,$orderdiscounts);
    ...
    public function buyStep2($post, $member_id, $member_name, $member_email, $orderdiscount = 0, $member_level = 0) {
        ...
        try {
            ...
            //scm 分单
            $orderids = array_keys($this->_order_data['order_list']);
            $orderid = $orderids[0];
            if($this->_order_data['order_list'][$orderid]['payment_code'] == 'offline') {
...
//             $order_platform_store_ids[$k] = null;
    ...
    private function _createOrderStep1() {
        ...
        $this->_order_data['input_pickup_type'] = $post['order_pickup_type'];
        $this->_order_data['input_pickup_store'] = $post['order_pickup_store'];
    }
...
//             }
            ...
            $order_common['pickup_type'] = $input_pickup_type;
            if($input_pickup_type==1) {
                $order_common['pickup_store'] = $input_pickup_store;
            }
